...
export const MOCK_MEETINGS: Meeting[] = [
  { id: 'mtg_001', title: 'Demo Produto - Acme Corp', date: '2026-02-20T14:00:00', duration: 45, sellerId: 'usr_004', sellerName: 'Julia Lima', clientName: 'Roberto Faria', clientEmail: 'roberto@acme.com', meetLink: 'https://meet.google.com/abc-def-ghi', status: 'completed', score: 87, aiAnalyzed: true, teamId: 'team_001', createdAt: '2026-02-20' },
  { id: 'mtg_002', title: 'Apresentação Inicial - TechFlow', date: '2026-02-21T10:00:00', duration: 30, sellerId: 'usr_005', sellerName: 'Diego Alves', clientName: 'Patrícia Nunes', clientEmail: 'patricia@techflow.com', meetLink: 'https://meet.google.com/xyz-abc-def', status: 'completed', score: 72, aiAnalyzed: true, teamId: 'team_002', createdAt: '2026-02-21' },
  { id: 'mtg_003', title: 'Follow-up - StartupX', date: '2026-02-22T15:30:00', duration: 60, sellerId: 'usr_004', sellerName: 'Julia Lima', clientName: 'Marcos Vieira', clientEmail: 'marcos@startupx.io', meetLink: 'https://meet.google.com/pqr-stu-vwx', status: 'completed', score: 91, aiAnalyzed: true, teamId: 'team_001', createdAt: '2026-02-22' },
  { id: 'mtg_004', title: 'Qualificação - Nexus SA', date: '2026-02-23T09:00:00', duration: 25, sellerId: 'usr_006', sellerName: 'Mariana Costa', clientName: 'Ana Lima', clientEmail: 'ana@nexus.com.br', status: 'completed', score: 65, aiAnalyzed: false, teamId: 'team_002', createdAt: '2026-02-23' },
  { id: 'mtg_005', title: 'Demo Avançada - GlobalTech', date: '2026-03-05T11:00:00', duration: 50, sellerId: 'usr_005', sellerName: 'Diego Alves', clientName: 'Carlos Stein', clientEmail: 'carlos@globaltech.com', meetLink: 'https://meet.google.com/mno-pqr-stu', status: 'scheduled', aiAnalyzed: false, teamId: 'team_002', createdAt: '2026-03-04' },
  { id: 'mtg_006', title: 'Proposta Comercial - InfoSoft', date: '2026-03-06T16:00:00', duration: 40, sellerId: 'usr_004', sellerName: 'Julia Lima', clientName: 'Beatriz Santos', clientEmail: 'beatriz@infosoft.com.br', status: 'scheduled', aiAnalyzed: false, teamId: 'team_001', createdAt: '2026-03-04' },
  { id: 'mtg_007', title: 'Negociação - Empresa XYZ', date: '2026-02-19T14:00:00', duration: 35, sellerId: 'usr_006', sellerName: 'Mariana Costa', clientName: 'Gustavo Prado', clientEmail: 'gustavo@xyz.com', status: 'no_show', aiAnalyzed: false, teamId: 'team_002', createdAt: '2026-02-19' },
];
...
export const MOCK_EVALUATIONS: Evaluation[] = [
  ...
  { id: 'eval_003', meetingId: 'mtg_003', evaluatorId: 'usr_003', rapport: 95, discovery: 90, presentation: 92, objections: 88, nextSteps: 90, totalScore: 91, aiSummary: 'Reunião excepcional. Melhor performance do mês para Julia.', aiInsights: 'Continue utilizando a mesma abordagem consultiva. Benchmark para o time.', createdAt: '2026-02-22' },
];
