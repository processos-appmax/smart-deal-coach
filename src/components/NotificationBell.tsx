...
export default function NotificationBell() {
  ...
  const panel = open ? (
    <div
      ref={panelRef}
      style={{ top: panelPos.top, right: panelPos.right, maxHeight: 'calc(100vh - 80px)' }}
      className="fixed w-[360px] rounded-2xl border border-border bg-popover shadow-2xl overflow-hidden animate-fade-in"
      // Inline style for z-index to guarantee it's above everything
      // eslint-disable-next-line react/forbid-dom-props
      {...{ style: { top: panelPos.top, right: panelPos.right, maxHeight: 'calc(100vh - 80px)', zIndex: 99999 } }}
    >
      {/* Header */}
